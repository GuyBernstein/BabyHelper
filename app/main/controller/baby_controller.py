...
async def list_babies(
    ...
    """Get all babies (requires authentication)"""
...
async def get_baby(
    ...
    """Get a baby by ID (requires authentication)"""
...
async def update_baby_info(
    ...
    """Update a baby's information (requires authentication)"""
...
async def remove_baby(
    ...
    """Delete a baby (requires authentication)"""
